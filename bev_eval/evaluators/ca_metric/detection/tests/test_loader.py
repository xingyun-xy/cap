...
class TestLoader(unittest.TestCase):
    def test_filter_eval_boxes(self):
        ...
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 0
        )  # box1 should be filtered.
        ...
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 0
        )  # both box1 and box2 should be filtered.
        ...
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 1
        )  # box1 and box2 to be filtered. box3 to stay.
        ...
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 2
        )  # box1, box2 to be filtered. box3, box4 to stay.
        self.assertEqual(filtered_boxes.boxes[sample_token][0].detection_name, "car")
        self.assertEqual(
            filtered_boxes.boxes[sample_token][1].detection_name, "bicycle"
        )
        ...
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 2
        )  # box1, box2, box5 filtered. box3, box4 to stay.
        self.assertEqual(filtered_boxes.boxes[sample_token][0].detection_name, "car")
        self.assertEqual(
            filtered_boxes.boxes[sample_token][1].detection_name, "bicycle"
        )
        ...
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 2
        )  # box1, box2, box5, box6 filtered. box3, box4 stay
        self.assertEqual(filtered_boxes.boxes[sample_token][0].detection_name, "car")
        self.assertEqual(
            filtered_boxes.boxes[sample_token][1].detection_name, "bicycle"
        )
        ...
        sample_token = (
            "ca9a282c9e77460f8360f564131a8af5"  # This sample has no bike-racks.
        )
        ...
        filtered_boxes = filter_eval_boxes(nusc, eval_boxes, max_dist)
        self.assertEqual(
            len(filtered_boxes.boxes[sample_token]), 3
        )  # box2, box4, box6 filtered. box1, box3, box5 stay
