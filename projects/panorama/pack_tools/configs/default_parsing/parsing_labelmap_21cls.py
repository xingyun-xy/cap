...
#add changan 
dst_label["parking_column"] = 16 #立柱
dst_label["no_parking_line"] = 17 #禁停线
dst_label["slow_down_line"] = 18 #减速让行线
dst_label["road_text"] = 19 #地面文字
dst_label["stop_attention_line"] = 20 #停止让行线
dst_label["toll_pole"] = 1 #收费杆
