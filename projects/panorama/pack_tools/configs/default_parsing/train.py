...
input_root_dir = f"/workspace/data/changan_data/semantic_parsing/zhoushi_horizon_format/horizon_format_1009"  #转换好的地平线原始数据格式路径
output_dir = f"/workspace/data/train/semantic_parsing/lmdb_zhoushi_1009"  #生成的lmdb路径
