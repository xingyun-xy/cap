...
class ResNetBevDepth(nn.Module):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 del_maxpool=False,
                 with_input=False):
        super(ResNetBevDepth, self).__init__()
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNetBevDepth, self).train(mode)
        self._freeze_stages()
