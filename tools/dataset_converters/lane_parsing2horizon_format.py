...
class LaneParsingToHorizon(object):
                    ...
                    with open(json_path,"r",encoding='utf-8') as f:
                        ...
                        for i, item in enumerate(label["markData"]['annotations']):
                            ...
                            try:  #捕获question为空的json
                                anno["attrs"]["color"] = COLOR_MAP[item["question"]["66"]]
                                anno["attrs"]["type"] = CLASS_MAP[item["question"]["62"]]
                                anno["attrs"]["ignore"] = item["question"]["63"]
                                anno["attrs"]["occlusion"] = OCCLUSION_MAP[item["question"]["65"]]
                                anno["attrs"]["double_line"] = item["question"]["64"]
                            except Exception as e:
...
if __name__ == '__main__':
    args = parse_args()
    converter = LaneParsingToHorizon(args.data_dir, args.save_dir ,args.log_path)
