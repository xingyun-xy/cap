...
def parse_args():
    ...
    parser.add_argument('--json_path', type=str, default='/data/train_save_dir/zoumingjie/vehicle_3d/nuscenes_all/nuscenes_infos_train_mono3d.coco.json', help='json_path')
    parser.add_argument('--img_base_path', type=str, default='/data/nuscenes_mini/mini/samples', help='img_base_path')
    parser.add_argument('--save_path', type=str, default='/data/train_save_dir/zoumingjie/vehicle_3d/nuscenes_all/train/', help='dir to save results')
...
def main():
    ...
    cl.convert() #转换标注格式
    cl.save_json() #保存转换后的json
    cl.save_all_imgs() #复制图片到data文件夹
